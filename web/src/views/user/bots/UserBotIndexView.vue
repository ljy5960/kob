        ...
        <div class="row">
            <div class="col-3">
                <div class="card" style="margin: 20px;">
                    <div class="card-body">
                        <img :src="$store.state.user.photo" alt="" style="width: 100%;"><!--表达式加冒号，字符串不用加 -->
                    </div>
                </div>
            </div>
            <div class="col-9">
                <div class="card" style="margin-top: 20px;"><!--文本加样式用span括起来 -->
    ...
    setup() {
        ...
        const add_bot = () => {
            botadd.error_message = "",
                $.ajax({
                    url: "https://app6957.acapp.acwing.com.cn/api/user/bot/add/",
                    type: "post",
                    data: {
                        title: botadd.title,
        ...
        const delete_bot = (bot) => {
            $.ajax({
                url: "https://app6957.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://app6957.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
